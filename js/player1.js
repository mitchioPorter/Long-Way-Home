...
function player1Control(){
    ...
    {
        if (player1.body.y<game.camera.view.y+560 && player2.body.y<game.camera.view.y+540 ){
    ...
    {
        if (player1.body.y>game.camera.view.y && player2.body.y>game.camera.view.y){
            player1.body.velocity.y = 150;
        }
        lastPress = 'down';
    ...
    {
        if (player1.body.x<game.camera.view.x+760  && player2.body.x<game.camera.view.x+760){
    ...
    {
        if (player1.body.x>game.camera.view.x && player2.body.x>game.camera.view.x){
            player1.body.velocity.x = 150;
        }
        lastPress = 'right';
